...
void InitializeVRAMForKernel() {
  constexpr uint64_t kernel_virtual_vram_base = 0xFFFFFFFF80000000ULL;
  ...
  constexpr uint64_t kernel_virtual_screen_base = 0xFFFFFFFF88000000ULL;
  CreatePageMapping(
...
extern "C" void KernelEntry(LiumOS* liumos_passed) {
  ...
  uint64_t kernel_stack_virtual_base = 0xFFFFFFFF20000000ULL;
